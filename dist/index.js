module.exports = /******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 965: /***/ (__unused_webpack_module, exports, __nccwpck_require__) => {
      ...
      const output_1 = __nccwpck_require__(481)
      const input = input_1.getInput()
      const output = {
        text: output_1.getOutputText(input.text)
      }
      output_1.setOutput(output)

      /***/
    },

    /***/ 911: /***/ function (__unused_webpack_module, exports, __nccwpck_require__) {
      var __importDefault =
    ...
    /***/ 481: /***/ function (__unused_webpack_module, exports, __nccwpck_require__) {
      var __importDefault =
        (this && this.__importDefault) ||
        function (mod) {
          return mod && mod.__esModule ? mod : { default: mod }
      ...
      Object.defineProperty(exports, "__esModule", { value: true })
      exports.setOutput = exports.getOutputText = void 0
      const core_1 = __importDefault(__nccwpck_require__(186))
      const getOutputText = (inputText) => {
        return `Text: ${inputText}`
      }
      exports.getOutputText = getOutputText
      const setOutput = (output) => {
        core_1.default.setOutput("text", output.text)
      }
      exports.setOutput = setOutput
